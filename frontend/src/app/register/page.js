    ...
    <div className="min-h-screen">
      ...
      <div className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Name of your Organization</label>
            <input
              type="text"
              value={orgname}
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Organization's number</label>
            <input
              type="tel"
              value={phNumber}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setName(e.target.value)}
              className="w-full rounded-lg border border-gray-300 p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
              placeholder="street address, city, state or province, postal code."
              required
            />
          </div>
          <button
        ...
        <p className="text-sm mt-4 text-center">
          ...
          <Link href="/">
            <span className="text-cta font-medium cursor-pointer">Sign in</span>
          </Link>
        </p>
      </div>
    </div>
